...
public class SimHash {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("======================================");
        System.out.println("文本相似度是：" +   hash1.getSemblance(hash3) );
        System.out.println("文本相似度：" +   hash2.getSemblance(hash3) );
        System.out.println("文本相似度是：" +   hash3.getSemblance(hash4) );
        long l4 = System.currentTimeMillis();
        List<Double> list =new LinkedList<>();
        list.add(hash1.getSemblance(hash3));
        list.add(hash2.getSemblance(hash3));
        list.add( hash3.getSemblance(hash4));
        Double max = Collections.max(list);
        System.out.println(max);
        System.out.println("总耗时: " + (l4-l3));
        System.out.println("======================================");
    }
}
