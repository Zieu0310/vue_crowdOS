...
public class RedisUtil {
    ...
    public Map<String, Object> hmget(String key) {
        // 将原始Map<Object, Object>转换为Map<String, Object>
        Map<String, Object> convertedMap = new HashMap<>();
        for (Map.Entry<Object, Object> entry : redisTemplate.opsForHash().entries(prefix + key).entrySet()) {
            String newKey = entry.getKey().toString(); // 将键转换为String类型
            Object value = entry.getValue(); // 值不需要转换
